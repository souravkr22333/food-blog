...
from .views import RecipeListCreateView, RecipeDetailView,RecipeListView, RecipecardView ,TrandingView
...
urlpatterns = [
    ...
    path('tranding/',TrandingView.as_view(), name='tranding-recipes')
]